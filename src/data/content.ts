...
export const systemsWork = {
  ...
  cards: [
    ...
    { title: "Governance built into the path", label: "AMAZON / RELIABILITY / PLATFORM", blueprint: "approval-workflow", problem: "Self-service logistics workflows created risk when approvals and configuration changes were hard to audit.", contribution: "Architected an event-driven approvals and audit platform with governance guardrails and role-scoped access.", outcome: "Designed to prevent an estimated $1.5M in potential losses from misconfigurations.", pattern: "Event-driven architecture · auditability · access control" },
    { title: "Modernizing a legacy broker component", label: "SS&C EZE / FINANCIAL SOFTWARE", problem: "A broker component built in Pascal/Delphi needed to move to a modern web application within an established trading environment.", contribution: "Migrated the legacy broker component to a modern web application, bringing existing trading functionality into a new interface.", outcome: "Delivered the migration from the Pascal/Delphi component to the web application. The work extended my experience in maintaining and evolving established financial software.", pattern: "Legacy modernization · web applications · trading workflows" },
  ],
};
